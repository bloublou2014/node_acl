...
var Acl = function (backend, logger, options){
  ...
  backend.getAllAsync = bluebird.promisify(backend.getAll);
...
/**
 roles( function(err, users) )

 Return all roles.
 @param {Function} Callback called when finished.
 @return {Promise} Promise resolved with an array of users
 */
Acl.prototype.roles = function(cb){
  return this.backend.getAllAsync(this.options.buckets.roles).nodeify(cb);
};

/**
 parentRoles( function(err, users) )

 Return all parent roles.
 @param {Function} Callback called when finished.
 @return {Promise} Promise resolved with an array of users
 */
Acl.prototype.parentRoles = function(cb){
  return this.backend.getAllAsync(this.options.buckets.parents).nodeify(cb);
};
...
/**
 ...
 @return {Promise} Promise resolved with an array of users
 */
Acl.prototype.users = function(cb){
  return this.backend.getAllAsync(this.options.buckets.users).nodeify(cb);
};
